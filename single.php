...
?>
	...
	<main id="primary" class="site-main">
		...
		while ( have_posts() ) :
			...
			/**
			 * Functions hooked into zen_wp_boilerplate_do_after_single_post_content action.
			 *
			 * @hooked zen_wp_boilerplate_the_post_navigation - 10
			 * @hooked zen_wp_boilerplate_comments_template - 15
			 */
			do_action( 'zen_wp_boilerplate_do_after_single_post_content' );
